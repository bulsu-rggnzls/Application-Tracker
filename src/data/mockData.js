...
const mockData = [
  ...
  },
  {
    ...
    checklist: [
      { id: uuidv4(), text: 'Review Linear API docs', done: false },
      { id: uuidv4(), text: 'Re-read job description', done: true },
      { id: uuidv4(), text: 'Prep questions for hiring manager', done: false },
    ],
    interviews: [],
    activityLog: [

...
export const ComposeEmailCard = ({
  ...
  return (
    <motion.div
      ...
      {/* Header */}
      <div
        className="flex flex-none items-center justify-between bg-[#F5F5F7] py-3 pr-3 pl-4 sm:py-4 sm:pr-4 sm:pl-5 dark:bg-zinc-900">
        <div className="flex items-center gap-2 sm:gap-3">
          <div
            className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#6B5FF5] text-white sm:h-10 sm:w-10 sm:rounded-xl">
            <Mail size={18} className="sm:w-5.5" strokeWidth={1.5} />
          </div>
          <span
            className="text-[14px] font-semibold tracking-tight text-[#29292B] sm:text-[15px] dark:text-zinc-100">
            Compose email
          </span>
        </div>
      ...
      {/* Scrollable Body */}
      <div
        className="custom-scrollbar flex-1 overflow-y-auto rounded-[18px] border border-[#E5E5E5] bg-white sm:rounded-4xl dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="relative min-h-37.5 px-4 py-2 sm:min-h-50 sm:px-8">
          ...
          <div className="mt-6 pb-4 sm:mt-8">
            <h4
              className="mb-3 text-[11px] font-medium tracking-widest text-[#A7A7A9] capitalize sm:mb-4 sm:text-[12px]">
              Attachments
            </h4>
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              {data.attachments.map((file) => (
                <motion.div
                  ...
                  <div
                    className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 text-[9px] font-bold text-gray-400 transition-colors group-hover:bg-[#F5F3FF] group-hover:text-[#6366F1] sm:h-11 sm:w-11 sm:text-[10px] dark:bg-zinc-800 dark:group-hover:bg-[#6366F1]/10">
                    {file.icon}
                  </div>
              ...
              {attachedFiles.map((fname) => (
                <motion.div
                  ...
                  <div
                    className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#F5F3FF] text-[9px] font-bold text-[#6366F1] sm:h-11 sm:w-11 sm:text-[10px] dark:bg-[#6366F1]/10">
      ...
      {/* Footer */}
      <div
        className="flex flex-none flex-col justify-between gap-4 border-gray-100 bg-[#F5F5F7] px-4 py-3 sm:flex-row sm:items-center sm:px-6 sm:py-4 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div
          ...
          <span
            className="max-w-[140px] min-w-0 truncate text-[11px] font-medium text-[#C6C5CA] sm:max-w-[180px]">

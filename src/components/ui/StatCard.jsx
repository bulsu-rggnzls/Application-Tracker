export default function StatCard({ label, value, sub, icon: Icon, color = 'indigo', className = '' }) {
  const accents = {
    ...
    violet: 'border-violet-200/80 dark:border-violet-800/60 bg-gradient-to-br from-violet-50/80 to-purple-50/50 dark:from-violet-950/40 dark:to-purple-950/30',
    ...
    emerald: 'border-emerald-200/80 dark:border-emerald-800/60 bg-gradient-to-br from-emerald-50/80 to-teal-50/50 dark:from-emerald-950/40 dark:to-emerald-950/30',
    ...
    <div className={`rounded-xl border px-4 py-3 shadow-sm hover:shadow-md transition-all duration-200 ${accents[color] || accents.indigo} ${className}`}>
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className={`text-xl font-extrabold tracking-tight tabular-nums leading-tight mt-0.5 ${valueColors[color] || valueColors.indigo}`}>{value}</p>

    ...
    <div className="mb-2 sm:mb-3">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <label className="hidden sm:flex items-center gap-1.5 shrink-0">
          ...
          <select
            ...
            className="px-2.5 py-2 text-xs font-medium text-text-secondary bg-surface border border-border rounded-lg focus-ring transition-ui appearance-none cursor-pointer"
          >
      ...
      <div className="flex sm:hidden items-center gap-2 mt-2 max-w-full">
        <select
          value={sort}
          onChange={(e) => onSortChange(e.target.value)}
          className="min-w-0 flex-1 px-2.5 py-1.5 text-xs font-medium text-text-secondary bg-surface border border-border rounded-lg focus-ring cursor-pointer transition-ui"
        >

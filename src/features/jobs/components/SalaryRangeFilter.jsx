...
import useSalaryRangeFilter from '../hooks/useSalaryRangeFilter'
...
export default function SalaryRangeFilter({ minSalary, maxSalary, sortHigh, onChange }) {
  const { localMin, setLocalMin, localMax, setLocalMax, hasSelection, applyPreset, applyCustom } = useSalaryRangeFilter({ minSalary, maxSalary, sortHigh, onChange })
